...
%  fbb with [libertine]{newtxtmath} and artemisa

% Unicode combinations:
%	libertine for Latin, Greek, and Hebrew 
%	fbb with SBL Greek and Hebrew

\usepackage{fontspec}
\usepackage{amsmath,amssymb,wasysym,textcomp}
