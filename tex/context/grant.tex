...
\mainlanguage       [en]
\setupinteraction   [
    title={Songs at the Woods' Edge: The Earth Songs of the Seneca Nation},
    author={Andrew A. Cashner, PhD}
]
...
\usebtxdataset      [master.bib]
\usebtxdefinitions  [chicago]

\let\wtitle\emph
\let\mkbibemph\emph
\let\mkbibquote\quotation

\define[1]\USD{\textdollar#1}

\hyphenation{Woods'-Edge}

\starttext
\title{Songs at the Woods' Edge: The Earth Songs of the Seneca Nation}
...
I am seeking funding to support a research project entitled \wtitle{Songs at
the Woods’ Edge: The Earth Songs of the Seneca Nation}.
...
\quotation{Woods'-Edge Greeting}, which was a way of welcoming outsiders into
the village and played an important role both in the functioning of the
Haudenosaunee League government and in treaty negotiations with Euro-Americans 
\cite[Richter:Ordeal].
...
\cite[Diamond:NativeAmericanNortheast].
...
\cite[Morgan:League].
He describes dances as so central to Haudenosaunee culture that
\quotation{they contain within themselves a picture and a realization of
Indian life}, to the extent that when the dance \quotation{loses its
attractions, they will cease to be Indians}
\cite[righttext={{261, 263}}][Morgan:League].
He later argues, however, that Native Americans will only be able to survive
in \quotation{civilization} if they give up their traditional ways, and so his
...
they were observing
\cite[Fenton:GreatLaw, Kurath:IroquoisMusic].
...
Digital Publication, which offers a maximum award amount of \USD{5,000} per
month for six to twelve months, starting January 1, 2023 at the earliest.
I also intend to apply for a Digital Justice Grant from the American Council
of Learned Societies; the Seed Grant program offers up to \USD{25,000} for a
...
Endowment for the Arts; grants range from \USD{10,000} to \USD{100,000} and
would start in January 2023. 
...
Philosophical Society (average \USD{3,000}, awarded in May 2022) and from the
...
Cashner:WLSCM32, 
Cashner:WLSCM36].
I began this project with the support of a University of Rochester Humanities
Center Fellowship in spring 2020. 
