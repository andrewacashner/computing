...
class Change {
    ...
    static String changeTableRow(String label, int amount) {
    ...
    public static void main(String[] args) {
        ...
        // TODO off by one cent ?
        int changeLeft = (int)(changeTotal * 100.0);
        ...
        String table = 
            changeTableRow("Dollars", changeDollars) +
            changeTableRow("Quarters", changeQuarters) + 
            changeTableRow("Dimes", changeDimes) + 
            changeTableRow("Nickels", changeNickels) +
            changeTableRow("Pennies", changePennies);
