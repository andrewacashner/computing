/* Oualline example 11-3 (bitmap graphics simulation) */
/* Modified to reverse direction of diagonal line */
...
#define SET_BIT(x,y) graphics[(x)/8][y] |= (0x01 << ((x)%8))
